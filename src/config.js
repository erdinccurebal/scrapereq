...
const { PORT, HOST, NODE_ENV, WEB_ADDRESS, AUTH_USERNAME, AUTH_PASSWORD, ACCESS_PASSWORD_WITHOUT_PROXY, TMP_DIR, RATE_LIMIT_WINDOW_MS, RATE_LIMIT_MAX_REQUESTS } = process.env
